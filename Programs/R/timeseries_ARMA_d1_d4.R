...
bunch_ts <- read_excel('segmented_bunching_data_20.xlsx', sheet = "d1_d4", col_names=TRUE)
...
forecast.t <- plot(forecast(armafit,h=30),ylab="Difference of Distance",xlab="Time")
legend(0,-1000,c("X Axis 1 unit=1/6 minute"))
abline(0, 0, col ="red")
points(135,0,col="black",pch=19)
points(143,0,col="black",pch=19)

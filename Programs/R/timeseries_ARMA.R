...
bunch_ts <- read_excel('segmented_bunching_data_20.xlsx', sheet = "d3_d4", col_names=TRUE)
...
forecast.t <- plot(forecast(armafit,h=100,fan=TRUE),ylab="Difference of Distance",xlab="Time")
legend(100,40000,c("X Axis 1 unit=1/6 minute"))
abline(0, 0, col ="red")
points(147,0,col="black",pch=19)
